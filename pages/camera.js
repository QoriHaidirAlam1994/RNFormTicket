...
export default class CameraList extends React.Component {
    ...
    takePicture = () => {
        ...
        if (this.camera) {
            this.camera
                .capture({metadata: imagesCapture})
    ...
    render() {
        return <View style={styles.container}>
            ...
            <View style={[styles.overlay, styles.bottomOverlay]}>
              {(!this.state.isRecording && <TouchableOpacity style={styles.captureButton} onPress={this.takePicture.bind(this)}>
